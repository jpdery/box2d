// requires 
var b2BodyDef = require('./body-def.js'); 
var b2ContactManager = require('./contact-manager.js'); 
var b2ContactSolver = require('./contacts/contact-solver.js'); 
var b2Island = require('./island.js'); 
var b2TimeStep = require('./time-step.js'); 
var b2Sweep = require('../common/math/sweep.js'); 
var b2Transform = require('../common/math/transform.js'); 
var b2Color = require('../common/color.js'); 
var b2Body = require('./body.js'); 
var b2Vec2 = require('../common/math/vec2.js'); 
var b2AABB = require('../collision/aabb.js'); 
var b2RayCastOutput = require('../collision/ray-cast-output.js'); 
var b2RayCastInput = require('../collision/ray-cast-input.js'); 
...
b2World.prototype.m_inv_dt0 =  null;// aliases  
